...
```
{
  "when": "2019-07-30T07:36:08.4182963Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "dropoffs": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.4182963Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
        ...
        "documents": [
          {
            ...
            "signee_name": "String",
            "comment": "String",
            "completed_on": "2019-07-30T07:36:08.3922943Z"
          }
        ],
        "integration_key": "String",
        "status": "String",
...
```
{
  "when": "2019-07-30T07:36:08.4192953Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "dropoffs": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.4192953Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
...
```
{
  "when": "2019-07-30T07:36:08.4172955Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4202988Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "pickups": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.4202988Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
...
```
{
  "when": "2019-07-30T07:36:08.4212991Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "pickups": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.4212991Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
...
```
{
  "when": "2019-07-30T07:36:08.4042961Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4132947Z",
  "where": [
    0.0,
    0.0
  ],
...
```
## Colelction Completed `collection.completed`
```
{
  "when": "2019-07-30T07:36:08.3752985Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "load": null,
  "collection_attempted_outcome": null,
  "collection_cancelled_outcome": null,
  "collection_items_outcome": null,
  "collection_parcels_defined_outcome": null,
  "collection_parcels_undefined_outcome": null,
  "collection_parcels_unknown_outcome": null
}
```
## Custom Activity Completed `custom_activity.completed`
```
{
  "when": "2019-07-30T07:36:08.4162956Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.398293Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "dropoff": {
    "integration_key": "string",
    "due_at": "2019-07-30T07:36:08.3992926Z",
    "quantity": {
      "value": 0.0,
      "units": "string"
    },
...
```
{
  "when": "2019-07-30T07:36:08.4023007Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "dropoff": {
    "integration_key": "string",
    "due_at": "2019-07-30T07:36:08.4023007Z",
    "quantity": {
      "value": 0.0,
      "units": "string"
    },
...
```
{
  ...
  "dropoff": {
    "integration_key": "string",
    "due_at": "2019-07-30T07:36:08.398293Z",
    "quantity": {
      "value": 0.0,
      "units": "string"
    },
...
```
{
  "when": "2019-07-30T07:36:08.4053006Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4073011Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  ...
  "when": "2019-07-30T07:36:08.3962946Z",
  "where": [
    0.0,
    0.0
  ]
...
```
{
  ...
  "when": "2019-07-30T07:36:08.4142965Z",
  "where": [
    0.0,
    0.0
  ]
...
```
{
  ...
  "travel_plan": {
    "start": "2019-07-30T07:36:08.3972933Z",
    "end": "2019-07-30T07:36:08.3972933Z",
    "pois": [
      {
        "travel_plan_poi_id": "String",
        "due_time": "2019-07-30T07:36:08.3972933Z",
        "geofence_id": "string",
  ...
  "pickups": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.3972933Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
  ...
  "dropoffs": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.3962946Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
...
```
{
  "when": "2019-07-30T07:36:08.3992926Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "dropoffs": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.4002926Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
...
```
{
  "when": "2019-07-30T07:36:08.4002926Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  ...
  "pickups": [
    {
      "integration_key": "string",
      "due_at": "2019-07-30T07:36:08.4012929Z",
      "quantity": {
        "value": 0.0,
        "units": "string"
      },
...
{
  "id": null,
  "when": "2019-07-30T07:36:08.4092991Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4032969Z",
  "where": [
    0.0,
    0.0
  ],
  ...
  "pickup": {
    "integration_key": "string",
    "due_at": "2019-07-30T07:36:08.4032969Z",
    "quantity": {
      "value": 0.0,
      "units": "string"
    },
...
```
{
  ...
  "pickup": {
    "integration_key": "string",
    "due_at": "2019-07-30T07:36:08.4042961Z",
    "quantity": {
      "value": 0.0,
      "units": "string"
    },
...
```
{
  "when": "2019-07-30T07:36:08.4082997Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.3953013Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4102973Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4152966Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4112959Z",
  "where": [
    0.0,
    0.0
  ],
...
```
{
  "when": "2019-07-30T07:36:08.4122945Z",
  "where": [
    0.0,
    0.0
  ],
